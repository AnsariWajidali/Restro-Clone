          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md bg-white rounded-md duration-200 w-[300px]">
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-center mt-2 gap-2">
                <FaFacebook className=" cursor-pointer text-3xl hover:text-blue-500 duration-200" />
                <FaGoogle className=" cursor-pointer text-3xl hover:text-primary duration-200" />
              </div>
            </div>
          </div>
        </div>
